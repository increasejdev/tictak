...
<html lang="en">
  ...
  <head>
    ...
    <link href="<%=request.getContextPath()%>/resources/css/scrolling-nav.css" rel="stylesheet">
						...
						<div class="list-group">
								<ul class="nav nav-tabs" id="myTab" role="tablist">		
									<li class="nav-item"><a class="nav-link" id="messages-tab"
										...
										aria-controls="messages" aria-selected="false">Описание
											проблемы</a></li>
								...
								<div class="tab-content">
									<div class="tab-pane active" id="home" role="tabpanel"
										aria-labelledby="home-tab">text</div>
									<div class="tab-pane" id="profile" role="tabpanel"
										aria-labelledby="profile-tab">test</div>
